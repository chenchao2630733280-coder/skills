...
## 3. 平台与引擎
平台:{Web H5 / 微信小游戏 / Windows Desktop / iOS / Android / WebGL}
引擎:{Phaser 3 / Pixi.js / 纯 Canvas / Godot 4 / Unity}
设计分辨率:{如 750x1624}
适配模式:{fitWidth / fitHeight / RESIZE}
依赖:{phaser、axios / godot 4.x / unity 2022.3 LTS}
理由:{一句话}
...
| 动机维度 | 是否满足 | 实现机制 |
|---|---|---|
| 自主(Autonomy) | {是/否} | {玩家有哪些选择空间,如多路线/多解法/自定义} |
| 胜任(Competence) | {是/否} | {难度如何递进让玩家感到技能成长,如等级/分数/成就} |
| 关联(Relatedness) | {是/否} | {是否有社交元素,如排行榜/分享/对战/合作} |

> 主导动机:{胜任 / 自主 / 关联,三选一或组合,决定数值曲线与系统侧重}
> - 胜任主导 → 难度递进曲线陡,成就系统重
> - 自主主导 → 多分支/多解法,选择面板重
> - 关联主导 → 社交/排行/对战系统重
